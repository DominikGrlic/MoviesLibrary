...
namespace CinemaProject.Data.Migrations
{
    ...
    [Migration("20230706062412_initial")]
            ...
            modelBuilder.Entity("CinemaProject.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 7, 16, 8, 24, 12, 514, DateTimeKind.Local).AddTicks(2770),
                            ImageUrl = "deadpool.jpg",
                            MovieCategory = 2,
                            Name = "Deadpool",
                            Price = 32.899999999999999,
                            ProducerId = 1,
                            StartDate = new DateTime(2023, 7, 6, 8, 24, 12, 514, DateTimeKind.Local).AddTicks(2738)
                        },
                        new
                        {
                            Id = 2,
                            CinemaId = 2,
                            Description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
                            EndDate = new DateTime(2023, 7, 21, 8, 24, 12, 514, DateTimeKind.Local).AddTicks(2777),
                            ImageUrl = "fightClub.jpg",
                            MovieCategory = 1,
                            Name = "Fight Club",
                            Price = 39.5,
                            ProducerId = 2,
                            StartDate = new DateTime(2023, 7, 6, 8, 24, 12, 514, DateTimeKind.Local).AddTicks(2775)
                        },
                        new
                        {
                            Id = 3,
                            CinemaId = 3,
                            Description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
                            EndDate = new DateTime(2023, 7, 16, 8, 24, 12, 514, DateTimeKind.Local).AddTicks(2782),
                            ImageUrl = "godFather.jpg",
                            MovieCategory = 9,
                            Name = "God Father",
                            Price = 40.0,
                            ProducerId = 3,
                            StartDate = new DateTime(2023, 7, 2, 8, 24, 12, 514, DateTimeKind.Local).AddTicks(2780)
                        },
                        new
                        {
                            Id = 4,
                            CinemaId = 4,
                            Description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
                            EndDate = new DateTime(2023, 7, 14, 8, 24, 12, 514, DateTimeKind.Local).AddTicks(2786),
                            ImageUrl = "mrMrs.jpg",
                            MovieCategory = 1,
                            Name = "Mr and Mr's Smith",
                            Price = 35.700000000000003,
                            ProducerId = 4,
                            StartDate = new DateTime(2023, 7, 4, 8, 24, 12, 514, DateTimeKind.Local).AddTicks(2785)
                        },
                        new
                        {
                            Id = 5,
                            CinemaId = 1,
                            Description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
                            EndDate = new DateTime(2023, 7, 21, 8, 24, 12, 514, DateTimeKind.Local).AddTicks(2791),
                            ImageUrl = "trainingDay.jpg",
                            MovieCategory = 3,
                            Name = "Training Day",
                            Price = 38.5,
                            ProducerId = 1,
                            StartDate = new DateTime(2023, 7, 9, 8, 24, 12, 514, DateTimeKind.Local).AddTicks(2789)
                        });
                });
